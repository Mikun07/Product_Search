  ...
  <header class="flex items-center justify-between px-4 py-3 bg-white dark:bg-obsidian-2 border-b border-gray-100 dark:border-obsidian-3 transition-colors shrink-0">
    ...
    <div class="flex items-center gap-2">
      ...
      >
        ...
        <div
          v-if="langOpen"
          class="absolute right-0 top-11 z-50 w-40 rounded-xl bg-white dark:bg-obsidian-2 border border-gray-100 dark:border-obsidian-3 shadow-xl overflow-hidden"
        >
          <button
      ...
      >
        ...
        <div
          v-if="currencyOpen"
          class="absolute right-0 top-11 z-50 w-48 rounded-xl bg-white dark:bg-obsidian-2 border border-gray-100 dark:border-obsidian-3 shadow-xl overflow-hidden"
        >
          <button
          ...
          >
            ...
            <span
              ...
              :class="ui.currency === code ? 'text-white/70' : 'text-gray-400'"
            >{{ code }}</span>
          </button>
        </div>
      </div>
      ...
      >
        ...
        <span
          ...
          class="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] flex items-center justify-center bg-red-500 text-white text-[10px] font-bold rounded-full px-1 leading-none border-2 border-white dark:border-obsidian-2"
        >
      ...
      >
        ...
        <span
          ...
          class="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] flex items-center justify-center bg-brand text-white text-[10px] font-bold rounded-full px-1 leading-none border-2 border-white dark:border-obsidian-2"
        >
